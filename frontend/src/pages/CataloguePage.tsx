 ...
 *
 * Sprint 4: movies are now fetched from the real back-end (Prisma + SQLite)
 * via movieService, so loading is asynchronous and includes a loading state.
 * useWatchlist similarly persists watchlist changes to the database.
 */
...
const CataloguePage = () => {
  ...
  if (loading) {
    return <main className="page-main"><p>Loading movies…</p></main>;
  }

  if (error) {
    return <main className="page-main"><p className="form-error">{error}</p></main>;
  }
